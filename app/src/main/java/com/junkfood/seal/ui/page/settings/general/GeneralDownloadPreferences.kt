...
fun GeneralDownloadPreferences(onNavigateBack: () -> Unit, navigateToTemplate: () -> Unit) {
    ...
    var playlistNumbering by remember { mutableStateOf(PLAYLIST_NUMBERING.getBoolean()) }
    ...
    Scaffold(
        ...
        content = {
            ...
            LazyColumn(modifier = Modifier, contentPadding = it) {
                ...
                item {
                    PreferenceSwitch(
                        title = stringResource(id = R.string.playlist_numbering),
                        onClick = {
                            playlistNumbering = !playlistNumbering
                            PreferenceUtil.updateValue(PLAYLIST_NUMBERING, playlistNumbering)
                        },
                        icon = Icons.Outlined.FormatListNumbered,
                        enabled = !isCustomCommandEnabled && downloadPlaylist,
                        description = stringResource(R.string.playlist_numbering_desc),
                        isChecked = playlistNumbering && downloadPlaylist,
                    )
                }
