...
class DownloadDialogViewModel(private val downloader: DownloaderV2) : ViewModel() {
    ...
    private fun downloadWithPreset(
        ...
        validUrls.forEach { url ->
            val isPlaylistUrl = preferences.downloadPlaylist || ((url.contains("list=", ignoreCase = true) || url.contains("/playlist", ignoreCase = true)) && !url.contains("watch?v=", ignoreCase = true) && !url.contains("youtu.be/", ignoreCase = true))
            if (isPlaylistUrl) {
