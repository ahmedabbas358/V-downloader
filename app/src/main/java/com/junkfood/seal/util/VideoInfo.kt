...
fun Format.containsVideo() = vcodec != "none" && vcodec != null
fun Format.isAudioOnly() = vcodec == "none" || vcodec == null
fun Format.containsAudio() = acodec != "none" && acodec != null
fun VideoInfo.availableFormats(): List<Format> = formats ?: emptyList()
val Format.effectiveBitrate: Double
    get() = tbr ?: vbr ?: abr ?: 0.0
