    ...
    suspend fun downloadTracks(
        ...
        runCatching {
            ...
            try {
                ...
                val requestedLangCodes = if (preferences.subtitleLanguage.isBlank() || preferences.subtitleLanguage.equals("all", ignoreCase = true)) {
                    emptySet()
                } else {
    ...
    suspend fun downloadSubtitlesDirectly(
        ...
        runCatching {
            ...
            try {
                ...
                val requestedLangCodes = if (subLangs.isBlank() || subLangs.equals("all", ignoreCase = true)) {
                    emptySet()
                } else {
