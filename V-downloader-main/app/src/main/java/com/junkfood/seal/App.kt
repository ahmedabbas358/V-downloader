        ...
        startKoin {
            ...
            modules(
                module {
                    ...
                    single { com.junkfood.seal.ui.page.downloadv2.operations.OperationsRepository(get(), com.junkfood.seal.util.DatabaseUtil.db) }
                    viewModel { com.junkfood.seal.ui.page.downloadv2.operations.OperationsViewModel(get()) }
