...
object FileUtil {
    ...
    @CheckResult
    fun scanFileToMediaLibraryPostDownload(title: String, downloadDir: String, includeSubtitles: Boolean = false): List<String> =
        File(downloadDir)
            .walkTopDown()
            ...
            .apply {
                ...
                removeAll {
                    it.contains(Regex(THUMBNAIL_REGEX)) || (!includeSubtitles && it.contains(Regex(SUBTITLE_REGEX)))
                }
            }
