                ...
                if (url.contains("instagram.com", ignoreCase = true) || url.contains("tiktok.com", ignoreCase = true)) {
                    ...
                    if (cobaltUrl != null) {
                        val fakeVideoInfo = VideoInfo(
                            ...
                            extractor = "Cobalt",
                            extractorKey = "Cobalt",
                            formats = listOf(Format(formatId = "cobalt", url = cobaltUrl, vcodec = "unknown", acodec = "unknown", ext = "mp4", formatNote = "Cobalt video"))
                        )
        ...
        with(downloadPreferences) {
            ...
            request
                ...
                .mapCatching { response ->
                    ...
                    } else if (!skipDownload && !downloadPreferences.downloadSubtitle) {
