...
## 1. Microsoft ONNX Runtime (Android)
* **License:** MIT License
* **Copyright:** (c) Microsoft Corporation
* **Repository:** https://github.com/microsoft/onnxruntime
* **Description:** Cross-platform, high-performance ML inferencing and training accelerator.

## 2. MDX-Net / UVR (Ultimate Vocal Remover) Models
* **License:** MIT License
* **Repository:** https://github.com/Anjok07/ultimatevocalremovergui
* **Description:** State-of-the-art music source separation and vocal extraction architecture.

## 3. Demucs / Hybrid Demucs (Meta AI Research)
* **License:** MIT License
